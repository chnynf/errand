"""Web dashboard interface for Paw."""
...
class WebInterface:
    """Serves the Paw dashboard over HTTP."""

    name = "web"

    def __init__(self, app: "PawApp", *, host: str = _DEFAULT_HOST, port: int = _DEFAULT_PORT):
        self._app = app
        self._host = host
        self._port = port
    ...
    async def start(self) -> None:
        ...
        from paw.interfaces.web.api import build_api
