"""FastAPI app for the Errand web dashboard."""
...
_SESSIONS_DIR = Path(__file__).resolve().parents[3] / "errand" / "sessions" / "_data"
...
COMPONENTS = [
    {
        "id": "config",
        "label": "Config",
        "description": "Loads config.json and provides ErrandConfig to all components.",
    ...
    },
    {
        "id": "runtime",
        "label": "Runtime",
        "description": "ErrandApp wires components, owns process lifecycle.",
...
def build_api(swarm_app: "ErrandApp") -> FastAPI:
    app = FastAPI(title="Errand Dashboard", docs_url=None, redoc_url=None)
