...
from swarm_agent.contracts.interfaces import UserMessage
...
class CliInterface:
    ...
    def __init__(self, app: "SwarmApp", debug: bool = False):
        self._app = app
        self._debug = debug
    ...
    async def start(self) -> None:
        ...
        print("Initializing Swarm CLI...")
        if self._debug:
            print("Debug mode enabled.")
        print("Swarm CLI Ready. Type 'exit' to quit.")
        print("-" * 50)
