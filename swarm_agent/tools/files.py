...
from swarm_agent.tools._file_access import list_dir as _scoped_list_dir
from swarm_agent.tools._file_access import read_file as _scoped_read_file


def _file_access_config():
    return load_swarm_config().file_access
