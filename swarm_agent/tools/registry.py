...
Each ``.py`` file under ``swarm_agent/tools/`` is auto-loaded as a tool
...
from swarm_agent.contracts.types import ToolDefinition
...
class ToolRegistry:
    """Registry of executable tools loaded from ``swarm_agent/tools/``."""
